# Family Size Choropleth Maps and Tables
...
### PUMA-level individual maps and table
...
[Tabular view](tables/puma_family_size_microdata.html)


### State-level individual maps and table
...
[Tabular view](tables/state_family_size_microdata.html)
...
### State-level household-based maps and table
...
### County-level household-based maps and tables
...
[Tabular view for all counties](tables/county_family_size_estimates.html)

[Tabular view for counties with at least 50,000 people](tables/county_family_size_estimates.html)

### Zip-level household-based maps and tables
...
[Tabular view for all zip codes with at least one resident](tables/county_family_size_estimates.html)

[Tabular view for counties with at least 1,000 households](tables/county_family_size_estimates.html)

### Nationwide estimates

[Tabular view](tables/us_family_size_estimates.html)
